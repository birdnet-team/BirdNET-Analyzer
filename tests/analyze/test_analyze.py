...
def test_analyze_with_speed_up_10_and_overlap_1(setup_test_environment):
    """Test analyzing with speed up."""
    env = setup_test_environment
    ...
    # Call function under test
    analyze(soundscape_path, env["output_dir"], audio_speed=audio_speed, top_n=1, overlap=1)
    expected_start_timestamps = list(range(0, 120, 20))
    expected_end_timestamps = [*list(range(30, 121, 20)), 120]
...
def test_analyze_with_speed_up_10_and_overlap_2(setup_test_environment):
    """Test analyzing with speed up."""
    env = setup_test_environment
    ...
    # Call function under test
    analyze(soundscape_path, env["output_dir"], audio_speed=audio_speed, top_n=1, overlap=2)
    expected_start_timestamps = list(range(0, 120, 10))
    expected_end_timestamps = [*list(range(30, 121, 10)), 120, 120]
