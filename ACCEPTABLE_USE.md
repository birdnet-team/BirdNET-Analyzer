...
Forks, derivative applications, or redistributed versions should not use the name "BirdNET", "BirdNET Analyzer", associated package names, or official project branding in a manner that could reasonably imply endorsement by the original project or its maintainers.
